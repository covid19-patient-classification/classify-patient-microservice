...
class Patient:
    ...
    def __repr__(self):
        return [{
            ...
            'respiratory_failure': self.boolean_to_integer(self.respiratory_failure),
            'ards': self.boolean_to_integer(self.ards),
            'sepsis_shock': self.boolean_to_integer(self.sepsis_shock),
            'fever': self.boolean_to_integer(self.fever),
            'cough': self.boolean_to_integer(self.cough),
            'sore_throat': self.boolean_to_integer(self.sore_throat),
            'headache': self.boolean_to_integer(self.headache),
            'fatigue': self.boolean_to_integer(self.fatigue),
            'dyspnea': self.boolean_to_integer(self.dyspnea),
            'nausea': self.boolean_to_integer(self.nausea),
            'vomit': self.boolean_to_integer(self.vomit),
            'diarrhea': self.boolean_to_integer(self.diarrhea)
        }]
