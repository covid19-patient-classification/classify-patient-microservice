...
from app.infrastructure.adapters.output.randomforest.mappers.patient_random_forest_mapper import PatientRandomForestMapper
import joblib


class PatientClassificationRandomForestAdapter(PatientClassificationOutputPort):
    def __init__(self):
        self.model_path = 'resources/model.joblib'
    ...
    def classify_patient(self, patient):
        ...
        # return PatientRandomForestMapper.covid19_severity_prediction_to_string(covid19_severity_prediction)
        return {"code": 200}
